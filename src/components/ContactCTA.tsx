...
export default function ContactCTA() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-secondary-surface text-zinc-900 overflow-hidden"
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px] sm:min-h-[550px]">
        ...
        <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-20 bg-secondary-surface space-y-8">
          <div className="space-y-4">
            ...
            <h2 ref={titleRef} className="text-4xl sm:text-5xl font-sans font-semibold tracking-tight leading-tight text-zinc-950 pt-2">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 pt-2">
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-regal-navy text-white font-bold text-xs uppercase tracking-widest hover:bg-regal-navy/90 transition-colors rounded-md shadow-lg"
            >
            ...
            <div className="flex flex-col gap-3 text-sm text-zinc-700 font-semibold">
              ...
              >
                <div className="w-8 h-8 rounded-full bg-secondary-surface flex items-center justify-center transition-colors shadow-xs">
                  <svg className="w-4 h-4 text-regal-navy" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
