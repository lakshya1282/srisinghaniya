...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* ── Content layer ── */}
      <div className="relative z-30 max-w-[1650px] mx-auto h-full pl-6 sm:pl-10 lg:pl-18 pr-4 sm:pr-8 lg:pr-10 flex flex-col justify-end pt-10 pb-5 md:pt-16 md:pb-8 gap-8">
